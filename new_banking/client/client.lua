...
local atms = {
	...
	{name="ATM", id=277, x=-31.44, y=-1659.75, z=30.0},
	...
	{name="ATM", id=277, x=231.32, y=367.56, z=106.11},
	...
	{name="ATM", id=277, x=903.56, y=-163.84, z=73.17},
	...
	---
	{name="ATM", id=277, x=-38.07, y=-1115.65, z=26.44},
	{name="ATM", id=277, x=-178.33, y=-1318.58, z=31.3},
	{name="ATM", id=277, x=420.27, y=-965.98, z=29.4},
	{name="ATM", id=277, x=165.44, y=-221.14, z=54.27},
	{name="ATM", id=277, x=-1391.01, y=-590.45, z=30.32},
	---
	...
	{name="ATM", id=277, x=-662.38, y=-854.16, z=24.48},
	...
	{name="ATM", id=277, x=-1282.54, y=-210.45, z=42.45},
        {name="�Traktor", id=277, x=315.24, y=-593.71, z=42.28},
}
--================================================================================================
...
if bankMenu then
	...
	if nearBank() or nearATM() then
		...
		local distance = GetDistanceBetweenCoords(search.x, search.y, search.z, playerloc['x'], playerloc['y'], playerloc['z'], true)
			...
			if distance <= 3 then
				DrawText3Ds(search.x, search.y, search.z + 0.2, tostring('Zmáckni [E] pro otevreni'))
...
function DrawText3Ds(x,y,z, text)
    ...
    DrawRect(_x,_y+0.0105, 0.025+ factor, 0.05, 0, 0, 0, 85)
end